...
export default function SwapButton({ selectedNFT, selectedToken, onSuccess, onError }: SwapButtonProps) {
  ...
  return (
    ...
    >
      <Button 
        onClick={handleSwap} 
        className="w-full bg-gradient-to-r from-pink-500 to-yellow-500 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl"
